...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ikbsyz8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ikbsyz8.containers.anotherwebservice.com/
...
```
git clone git@github.com:Yeager28/container-ikbsyz8.git
cd container-ikbsyz8
```
...
```
docker attach container-ikbsyz8
```
